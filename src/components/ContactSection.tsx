...
const ContactSection = () => {
  return (
    <section className="w-full min-h-[100svh] bg-secondary/30 flex items-center justify-center relative overflow-hidden pt-20 sm:pt-24 lg:pt-28 pb-10 sm:pb-12">
